...
public class MCreatorSpeedForceWarp extends Elementsarrowverse.ModElement {
	@OnlyIn(Dist.CLIENT)
	...
	public void initElements() {
		keys = new KeyBinding("key.mcreator.speedforcewarp", GLFW.GLFW_KEY_X, "key.categories.misc");
