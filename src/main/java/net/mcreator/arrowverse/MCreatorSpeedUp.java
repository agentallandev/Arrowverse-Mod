...
public class MCreatorSpeedUp extends Elementsarrowverse.ModElement {
	@OnlyIn(Dist.CLIENT)
	...
	public void initElements() {
		keys = new KeyBinding("key.mcreator.speedup", GLFW.GLFW_KEY_Z, "key.categories.misc");
	...
	private static void pressAction(PlayerEntity entity) {
			...
			return;
		{
			...
			MCreatorMoreSpeed.executeProcedure($_dependencies);
		}
	}
}
