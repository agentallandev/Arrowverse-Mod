...
public class MCreatorAlloySmelterGui extends Elementsarrowverse.ModElement {
	public static HashMap guiinventory = new HashMap();
	public static IInventory inherited;
	private static ContainerType<GuiContainerMod> containerType = null;

	public MCreatorAlloySmelterGui(Elementsarrowverse instance) {
		super(instance, 19);
	...
	public static class GuiContainerMod extends Container {
		...
		public void initContainer(PlayerInventory inv, IInventory inheritedinv) {
			...
			this.addSlot(new Slot(inherited, 3, 126, 23) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
			});
			this.addSlot(new Slot(inherited, 0, 18, 22) {
			});
			this.addSlot(new Slot(inherited, 1, 64, 22) {
			});
			this.addSlot(new Slot(inherited, 2, 41, 58) {
			});
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				arrowverse.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("arrowverse:textures/alloysmeltergui.png");
		...
		protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
			this.font.drawString("Alloy Smelter", 52, 4, -15198184);
			this.font.drawString("Ingot", 14, 39, -15198184);
			this.font.drawString("Fuel", 39, 76, -15198184);
			this.font.drawString("Material 2", 47, 39, -15198184);
			this.font.drawString("Output", 118, 40, -15198184);
		}
		...
		public void init(Minecraft minecraft, int width, int height) {
			...
			this.addButton(new Button(this.guiLeft + 109, this.guiTop + 56, 50, 20, "Smelt", e -> {
				arrowverse.PACKET_HANDLER.sendToServer(new ButtonPressedMessage(0, x, y, z));
		...
		if (buttonID == 0) {
			{
				...
				MCreatorAlloySmelterCrafting.executeProcedure($_dependencies);
			}
		}
	}
