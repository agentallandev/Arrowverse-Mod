...
public class MCreatorSuitFabricatorGui extends Elementsarrowverse.ModElement {
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("suitfabricatorgui"));
	}
	...
	public static class GuiContainerMod extends Container {
		...
		public void initContainer(PlayerInventory inv, IInventory inheritedinv) {
			...
			this.addSlot(new Slot(inherited, 0, 35, 32) {
			});
			this.addSlot(new Slot(inherited, 1, 13, 32) {
			});
			this.addSlot(new Slot(inherited, 2, 35, 10) {
			});
			this.addSlot(new Slot(inherited, 3, 56, 31) {
			});
			this.addSlot(new Slot(inherited, 4, 35, 53) {
			});
			this.addSlot(new Slot(inherited, 5, 118, 32) {
				@Override
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("arrowverse:textures/suitfabricatorgui.png");
		...
		protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
			this.font.drawString("Suit Fabricator", 88, 5, -15198184);
		}
