...
public class MCreatorReverseSpeedSoles extends Elementsarrowverse.ModElement {
	@ObjectHolder("arrowverse:reversespeedsoles")
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("reversespeedsoles");
		}
